...
/**
 * The standalone library brush discovery class
 *
 * @package \TYPO3\Beautyofcode\Configuration\Brush
 * @author Thomas Juhnke <typo3@van-tomas.de>
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 */
class StandaloneBrush {

	protected $brushesPath = 'EXT:beautyofcode/Resources/Public/Javascript/vendor/syntax_highlighter/v3/scripts/';
	...
	protected function discoverBrushes() {
		...
		$this->discoveredBrushes = \TYPO3\CMS\Core\Utility\GeneralUtility::getFilesInDir(
			...
			FALSE,
			'1',
			'sh(BrushPlain|Autoloader|Core|Legacy)\.js'
		);
	}
}
?>