plugin.tx_beautyofcode_pi1 {
	...
	## FILES
		# cat=beautyofcode/file/010; type=string; label=Template - template file path:
	templateFile = EXT:beautyofcode/Resources/Private/Templates/template.html
	...
	jquery.selector =
		...
		# cat=beautyofcode/file/050; type=boolean; label=Global jQuery noConflict: If set to true all embedded jQuery Java-Script code will be wrapped in jQuery's noConflict() function. See documentation for more information.
	jQueryNoConflict = 0
	...
	jQueryOnReadyCallback = (document).ready(function(){
